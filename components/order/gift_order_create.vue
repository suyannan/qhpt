  ...
  export default {
    ...
    methods: {
          ...
          if (res.data.errcode == 0) {
            ...
            _this.$dialog.confirm({
              ...
              opts: () => {
                ...
                sessionStorage.setItem('redirect', '/main/gift_order_create');
                _this.$router.push({
                  path: '/unlogin',
                  query: {redirect: '/main/gift_order_create'}
                });
              }
            });
          } else {
      ...
      choose_pay_type(type) {
        ...
        sessionStorage.setItem('pay_type', this.pay_type);
        //sessionStorage.setItem('choosedVoucher', JSON.stringify(this.choosedVoucher));
        this.$router.push('/main/pay?type=' + type + '&back=/main/gift_order_create')
      }
    },
